#!/usr/bin/env node
/**
 * Flips `usePlaybackVideo: true` on @sia so the next incoming
 * call to her account publishes /playback/sia.mp4 (cropped 100px
 * from top and bottom in agora.js) as the outgoing video track
 * instead of her live camera.
 *
 *   cd backend
 *   node scripts/set-sia-playback-video.js          # preview
 *   node scripts/set-sia-playback-video.js --apply  # commit
 *
