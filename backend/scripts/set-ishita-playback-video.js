#!/usr/bin/env node
/**
 * Flips `usePlaybackVideo: true` on @ishita so the next incoming
 * call to her account publishes /playback/ishita.mp4 (cropped 100px
 * from top and bottom in agora.js) as the outgoing video track
 * instead of her live camera.
 *
 *   cd backend
 *   node scripts/set-ishita-playback-video.js          # preview
 *   node scripts/set-ishita-playback-video.js --apply  # commit
 *
